...
const lang = {
  ...
  DATAUPLOAD_LABEL: 'Data Uploads',
  DELETE: 'Delete',
  DELETE_DEVICE: 'Delete device',
  DELETE_DEVICE_DESCRIPTION: 'This action will delete the devices permanently from the platform.',
  DESCRIPTION: 'Description',
  DEVICECONFIGURATION: 'Device configuration',
  DEVICECOUNT: 'devices affected by this rule',
  DEVICEDETAIL: 'Device Detail',
  DEVICEID: 'DeviceId',
  DEVICELOCATION: 'Device locations',
  ...
  DEVICES_TAGGED: 'devices tagged',
  DEVICES_SCHEDULED: 'devices scheduled',
  DEVICES_RECONFIGURED: 'devices reconfigured',
  ...
  SIMULATION_SETTINGS_DESC: 'Start or stop simulation of devices. Stopping device simulation will minimize the cost of the solution; no simulated telemetry will be sent to your IoT Hub and alarms will not be generated for simulated devices.',
  ...
  TYPE: 'Type',
  UNKNOWN_ERROR: 'Oops, we encountered an unknown error',
  UPDATE: 'Update',
  VALUE: 'Value',
